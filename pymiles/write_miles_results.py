...
class write_miles_results:
    ...
    def __init__(self, object=None):
        ...
        # or SSP Models Class
        if (
            object.source == "MILES_SSP"
            or object.source == "EMILES_SSP"
            or object.source == "CaT_SSP"
        ) and ("object.time" not in locals()):
            # Copying basic info
            #         self.index     = np.nan
        ...
        if (
            object.source == "MILES_STARS"
            or object.source == "EMILES_STARS"
            or object.source == "CaT_STARS"
        ):
            # Copying basic info
    ...
    def spec_to_fits(self):
        ...
        for i in range(self.nspec):
            ...
            hdr[
                "COMMENT"
            ] = "# This spectrum has been produced using the Webtool facilities"
            hdr[
                "COMMENT"
            ] = "# of the MILES website (http://miles.iac.es) hosted at the"
            hdr[
                "COMMENT"
            ] = "# Instituto de Astrofisica de Canarias using the population"
            hdr[
                "COMMENT"
            ] = '# synthesis code "MILES" (MIL EStrellas). See Vazdekis (1999),'
            hdr[
                "COMMENT"
            ] = "# Vazdekis et al. (2003, 2010, 2015, 2016) for details on the code"
            ...
            hdr[
                "COMMENT"
            ] = '# "from the MILES website", while we suggest to add to your'
            ...
            hdr[
                "COMMENT"
            ] = "# We would appreciate receiving a preprint for our records."
            hdr["COMMENT"] = "#       "
            hdr["COMMENT"] = "#                   --------------------"
            hdr["COMMENT"] = "#       "
            hdr[
                "COMMENT"
            ] = "# This spectrum is provided as is without any warranty whatsoever."
            hdr[
                "COMMENT"
...
# - Tampoco sé muy bien cual es la forma mas optima de pasarle en algunos
# casos age, met... y otros teff,loggg..
